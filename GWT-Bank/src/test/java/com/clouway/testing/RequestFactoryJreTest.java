...
import com.clouway.gwtbank.inject.InjectingServiceLayerDecorator;
import com.clouway.gwtbank.inject.RequestFactoryInjectingModule;
import com.clouway.gwtbank.server.BankUserRepository;
...
/**
 * Provides an way of directly injection of {@link com.google.web.bindery.requestfactory.shared.RequestFactory} classes and target classes marked as {@literal@}ProvidedService. To provide injection
 ...
 * </pre>
 * <p/>
 * To may run RequestFactory classes in simple JRE test, the {@link RequestFactoryJreTest} is using {@link com.google.web.bindery.requestfactory.vm.RequestFactorySource#create(Class)}  method
 * to create the application {@link com.google.web.bindery.requestfactory.shared.RequestFactory} then is initializing it using {@link com.google.web.bindery.requestfactory.server.testing.InProcessRequestTransport} and the EventBus.
 * <p/>
 * RequestFactoryJreTest is an base test of all tests that are using {@link com.google.web.bindery.requestfactory.shared.RequestFactory} and are using mock objects
...
public abstract class RequestFactoryJreTest {
    ...
    Injector injector = Guice.createInjector(
            ...
            new AbstractModule() {
                ...
                protected void configure() {
                    ...
                    bind(UserRepository.class).to(InMemoryUserRepo.class);
  ...
  /**
   * Creates new instance of {@link com.google.web.bindery.requestfactory.shared.RequestFactory} and binds it to the provided Guice Binder, so it
